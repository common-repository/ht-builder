    ...
    protected function render( $instance = [] ) {
        ...
        if( Elementor::instance()->editor->is_edit_mode() ){
            ...
            if( Elementor::$instance->db->is_built_with_elementor( $post->ID ) ){
                ...
                wp_link_pages( [
                    'before' => '<div class="page-links"><span class="page-links-title elementor-page-links-title">' . esc_html__( 'Pages:', 'ht-builder' ) . '</span>',
                    'after' => '</div>',
                    'link_before' => '<span>',
                    'link_after' => '</span>',
                    'pagelink' => '<span class="screen-reader-text">' . esc_html__( 'Page', 'ht-builder' ) . ' </span>%',
